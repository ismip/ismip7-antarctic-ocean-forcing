...
def download_imbie():
    ...
    sample_output = 'imbie2/ANT_Basins_IMBIE2_v1.6/ANT_Basins_IMBIE2_v1.6.shp'
    if os.path.exists(sample_output):
        return

    filename = 'ANT_Basins_IMBIE2_v1.6.zip'
    dest_path = os.path.join('imbie2', filename)
    ...
    # unzip
    with zipfile.ZipFile('imbie2/ANT_Basins_IMBIE2_v1.6.zip', 'r') as f:
        f.extractall('imbie2/ANT_Basins_IMBIE2_v1.6/')
    print('  Done.')
