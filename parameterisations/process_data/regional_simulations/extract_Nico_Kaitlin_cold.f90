...
file_out_S = 'Jourdain-Naughten_NEMO-MITgcm_cold_S.nc'
file_out_T = 'Jourdain-Naughten_NEMO-MITgcm_cold_T.nc'
file_out_m = 'Jourdain-Naughten_NEMO-MITgcm_cold_m.nc'
...
102 FORMAT('/scratchu/njourdain/ISMIP7_REGIONAL_OCEAN_DATA/DATA/Nico/climato_Amundsen_NEMO-',a,'_1989-2009.nc')
...
status = NF90_PUT_ATT(fidS,NF90_GLOBAL,"history","Created using extract_Nico_Kaitlin_cold.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL1_ID")
...
status = NF90_PUT_ATT(fidT,NF90_GLOBAL,"history","Created using extract_Nico_Kaitlin_cold.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL1_ID")
...
status = NF90_PUT_ATT(fidm,NF90_GLOBAL,"history","Created using extract_Nico_Kaitlin_cold.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL1_ID")
