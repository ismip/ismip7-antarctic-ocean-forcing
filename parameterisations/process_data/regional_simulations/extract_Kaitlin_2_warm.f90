...
file_out_S = 'Naughten_MITamu-MITwed_warm_S.nc'
file_out_T = 'Naughten_MITamu-MITwed_warm_T.nc'
file_out_m = 'Naughten_MITamu-MITwed_warm_m.nc'
...
status = NF90_PUT_ATT(fidS,NF90_GLOBAL,"history","Created using extract_Kaitlin_2_warm.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL1_ID")
...
status = NF90_PUT_ATT(fidT,NF90_GLOBAL,"history","Created using extract_Kaitlin_2_warm.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL1_ID")
...
status = NF90_PUT_ATT(fidm,NF90_GLOBAL,"history","Created using extract_Kaitlin_2_warm.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL1_ID")
