...
class Run:
    ...
    def get_coordinates(self):
        ...
        # Should be generalised for all models using a mask in lon-lat dimensions
    ...
    def get_volume(self):
        # Read volume and other relevant variables for volume-weighting of T and S
        if self.model in ['CESM2']:
            ...
            # Select specified domain (horizontal and vertical). Note: volume is time-independent for this model
    ...
    def get_bins(self):
        # Create 2D histogram of volume Vb in terms of binned salinity Sb and temperature Tb
